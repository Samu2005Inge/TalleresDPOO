...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca en la lista de atletas si existe
	 * 
	 * @param nombreA El nombre del atleta a buscar
	 * @return paisA Pais que representa el atleta
	 */
	public String paisporAtleta (String nombreA)
	{
		String paisA="pais";
