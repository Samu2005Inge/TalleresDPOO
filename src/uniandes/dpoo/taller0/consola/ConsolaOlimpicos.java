...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar atleta por nombre");
		System.out.println("14. Salir de la aplicación\n");
	}
	/**
	 * Le muestra a que pais representa el atleta ingresado, si existe
	 */
	private void ejecutarAtletaNombre()
	{
		System.out.println("\n" + "\"Atleta por nombre\"" + "\n");
		String nombreA = input("Por favor ingrese el nombre de un atleta");
		String pais = calculadora.paisporAtleta(nombreA);
		if (pais != "pais")
		{
			System.out.println("El atleta "+nombreA+" representa al pais "+nombreA);
		}
		else {
			System.out.println("El nombre "+nombreA+" no se encontro en la base de datos");
		}
	}
	/**
